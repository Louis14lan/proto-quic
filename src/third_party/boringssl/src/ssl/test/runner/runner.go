...
func addExtendedMainSecretTests() {
	...
	testCases = append(testCases, testCase{
		name: "ExtendedMainSecret-Renego-NoEMS",
		config: Config{
			MaxVersion: VersionTLS12,
			Bugs: ProtocolBugs{
				NoExtendedMainSecret:                true,
				NoExtendedMainSecretOnRenegotiation: true,
			},
		},
		renegotiate: 1,
		flags: []string{
	...
	testCases = append(testCases, testCase{
		name: "ExtendedMainSecret-Renego-Upgrade",
		config: Config{
			MaxVersion: VersionTLS12,
			Bugs: ProtocolBugs{
				NoExtendedMainSecret: true,
	...
	testCases = append(testCases, testCase{
		name: "ExtendedMainSecret-Renego-Downgrade",
		config: Config{
			MaxVersion: VersionTLS12,
			Bugs: ProtocolBugs{
				NoExtendedMainSecretOnRenegotiation: true,
